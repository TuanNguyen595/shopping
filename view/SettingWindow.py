...
class SettingWindow(QWidget):
  ...
  def createLayout(self):
    ...
    layout.addWidget(QLabel("Scanner Port"), 0, 0, Qt.AlignmentFlag.AlignCenter)
    self.portEdit = QLineEdit()
    self.portEdit.setText(self.db.loadSetting("scanner_port"))
    layout.addWidget(self.portEdit, 0, 1, Qt.AlignmentFlag.AlignCenter)
    layout.addWidget(QLabel("Scanner Baudrate"), 1, 0, Qt.AlignmentFlag.AlignCenter)
    self.baudrateEdit = QLineEdit()
    self.baudrateEdit.setText(self.db.loadSetting("scanner_baudrate"))
    layout.addWidget(self.baudrateEdit, 1, 1, Qt.AlignmentFlag.AlignCenter)
    self.bankNumberEdit = QLineEdit()
    layout.addWidget(QLabel("Bank number"), 2, 0, Qt.AlignmentFlag.AlignCenter)
    self.bankNumberEdit.setText(self.db.loadSetting("bank_number"))
    layout.addWidget(self.bankNumberEdit, 2, 1, Qt.AlignmentFlag.AlignCenter)
    layout.addWidget(QLabel("Bank Bin"), 3, 0, Qt.AlignmentFlag.AlignCenter)
    self.bankBinEdit = QLineEdit()
    self.bankBinEdit.setText(self.db.loadSetting("bank_bin"))
    layout.addWidget(self.bankBinEdit, 3, 1, Qt.AlignmentFlag.AlignCenter)


    layout.addWidget(self.saveButton, 4, 0, Qt.AlignmentFlag.AlignCenter)
    pass
